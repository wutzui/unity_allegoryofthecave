...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Allegory_of_the_Cave.data';
    var REMOTE_PACKAGE_BASE = 'Allegory_of_the_Cave.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 5519522;
      var PACKAGE_UUID = 'f25ffce2-f4b0-4648-9dc0-1ecf457b60bb';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 2582110, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(2582110, 2582129, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(2582129, 2590493, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(2590493, 4616925, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(4616925, 5491897, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(5491897, 5519522, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Allegory_of_the_Cave.data');

    };
    Module['addRunDependency']('datafile_Allegory_of_the_Cave.data');
